...
$CFG['UserDBUser'] = 'rsyslogdbadmin';
$CFG['UserDBPass'] = 'rsyslogdbadmin';
...
$CFG['Sources']['Source1']['DBServer'] = 'db';
$CFG['Sources']['Source1']['DBName'] = 'Syslog';
$CFG['Sources']['Source1']['DBUser'] = 'rsyslogdbadmin';
$CFG['Sources']['Source1']['DBPassword'] = 'rsyslogdbadmin';
